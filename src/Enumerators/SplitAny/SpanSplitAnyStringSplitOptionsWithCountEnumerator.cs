...
namespace SpanExtensions.Enumerators
{
    ...
    public ref struct SpanSplitAnyStringSplitOptionsWithCountEnumerator
    {
        ...
        /// <summary>
        /// Constructs a <see cref="SpanSplitAnyStringSplitOptionsWithCountEnumerator"/> from a span and a delimiter. <strong>Only consume this class through <see cref="SpanExtensions.SplitAny(Span{char}, ReadOnlySpan{char}, int, StringSplitOptions, CountExceedingBehaviour)"/></strong>.
        /// </summary>
        ...
        public SpanSplitAnyStringSplitOptionsWithCountEnumerator(Span<char> source, ReadOnlySpan<char> delimiters, int count, StringSplitOptions options, CountExceedingBehaviour countExceedingBehaviour = CountExceedingBehaviour.AppendRemainingElements)
        {
            Span = source;
